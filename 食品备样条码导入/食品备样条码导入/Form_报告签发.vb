...
Public Class Form_报告签发
 Public guid As String = ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        cmd.CommandText = "select guid,报告编号,样品名称,主检科室,检验类型,计划编号,协议编号,抽样单编号,受检单位,生产单位,抽样单位,下达日期,商定完成日期,要求完成日期,检验结束日期,主检,受理人,当前进度,委托单位地址 from 检验任务 where 进度=@进度 and (主检科室=@主检科室 or @主检科室='') and (主检<>@当前人 or @当前人='') and (审核<>@当前人 or @当前人='') and (报告编号 like @报告编号 or @报告编号='') order by 报告编号"
        cmd.Parameters.AddWithValue("进度", 16)
    ...
    Private Sub form_报告签发_Resize(sender As Object, e As EventArgs) Handles Me.Resize
    ...
    Private Sub form_报告签发_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub form_报告签发_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Button11_Click(sender As Object, e As EventArgs) Handles Button11.Click
        ...
        TextBox6.Text += ("【报告签发】" + Now.ToString + " " + glb_姓名 + ":" + TextBox7.Text)
        TextBox7.Text = ""
    End Sub
    ...
    Private Sub form_报告签发_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        If Button2.Enabled Then
